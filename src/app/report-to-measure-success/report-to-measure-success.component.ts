...
@Component({
  selector: 'app-report-to-measure-success',
  standalone: true,
  imports: [CommonModule, RouterModule,NgxPaginationModule,FormsModule],
  templateUrl: './report-to-measure-success.component.html',
  styleUrl: './report-to-measure-success.component.scss'
})
export class ReportToMeasureSuccessComponent implements OnInit {
