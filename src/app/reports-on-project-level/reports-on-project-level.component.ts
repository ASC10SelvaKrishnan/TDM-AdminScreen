...
@Component({
  selector: 'app-reports-on-project-level',
  standalone: true,
  imports: [CommonModule, RouterModule,NgxPaginationModule,FormsModule],
  templateUrl: './reports-on-project-level.component.html',
  styleUrl: './reports-on-project-level.component.scss'
})
export class ReportsOnProjectLevelComponent implements OnInit{
